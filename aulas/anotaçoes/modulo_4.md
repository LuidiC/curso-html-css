...
- _Style Sheet_: é o nome dado ao arquivo de estilização que contém os _seletores_(formas de identificar um elemento em uma página, em quem irei realizar a formatação) e as _regras de estilização_(aquilo que irei fazer na formatação).
